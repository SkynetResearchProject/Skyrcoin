...
This issue tracker is only for technical issues related to Skyrcoin Core.
General Skyrcoin questions and/or support requests and are best directed to the [Skyrcoin Discord](https://discord.gg/).
...
### What version of Skyrcoin Core are you using?
