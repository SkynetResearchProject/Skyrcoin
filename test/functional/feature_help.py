...
"""Verify that starting skyrcoin with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start skyrcoin with -? for help text")
        ...
        self.log.info("Start skyrcoin with -version for version information")
