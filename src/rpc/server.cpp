...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    if (jsonRequest.fHelp || jsonRequest.params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop Skyrcoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Skyrcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
	...
	{"network", "getnodeblockcount", &getnodeblockcount, true },
        ...
        /* SKYR features */
        {"skyrcoin", "listmasternodes", &listmasternodes, true },
        {"skyrcoin", "getmasternodecount", &getmasternodecount, true },
        {"skyrcoin", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"skyrcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        ...
        {"skyrcoin", "getactivemasternodecount", &getactivemasternodecount, true },
        {"skyrcoin", "getmasternodestatus", &getmasternodestatus, true },
        {"skyrcoin", "getmasternodewinners", &getmasternodewinners, true },
        {"skyrcoin", "getmasternodescores", &getmasternodescores, true },
        {"skyrcoin", "preparebudget", &preparebudget, true },
        {"skyrcoin", "submitbudget", &submitbudget, true },
        {"skyrcoin", "mnbudgetvote", &mnbudgetvote, true },
        {"skyrcoin", "getbudgetvotes", &getbudgetvotes, true },
        {"skyrcoin", "getnextsuperblock", &getnextsuperblock, true },
        {"skyrcoin", "getbudgetprojection", &getbudgetprojection, true },
        {"skyrcoin", "getbudgetinfo", &getbudgetinfo, true },
        {"skyrcoin", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"skyrcoin", "mnfinalbudget", &mnfinalbudget, true },
        {"skyrcoin", "checkbudgets", &checkbudgets, true },
        {"skyrcoin", "mnsync", &mnsync, true },
        {"skyrcoin", "spork", &spork, true },
        {"skyrcoin", "mnping", &mnping, true },
...
{
    return "> skyrcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:16890/\n";
}
