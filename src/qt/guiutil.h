...
/** Utility functions used by the Skyrcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render SKYR addresses in monospace font
...
// Parse "skyrcoin:" URI into recipient object, return true on successful parsing
