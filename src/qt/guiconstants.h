...
/* Skyrcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Skyrcoin"
#define QAPP_ORG_DOMAIN "skynet-coin.com"
#define QAPP_APP_NAME_DEFAULT "Skyrcoin-Qt"
#define QAPP_APP_NAME_TESTNET "Skyrcoin-Qt-testnet"
