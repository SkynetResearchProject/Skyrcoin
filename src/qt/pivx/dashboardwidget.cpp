    ...
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of SKYR earned via Staking and Masternodes"));
	...
	ui->labelAmountMNRewards->setText("0 SKYR");
...
bool DashboardWidget::loadChartData(bool withMonthNames)
{
    ...
    chartData->amountsByCache = getAmountBy(); // pair SKYR, zSKYR
