...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Skyrcoin skyrcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  skyrcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded skyrcoin transaction") + "\n" +
                               "  skyrcoin-tx [options] -create [commands]   " + _("Create hex-encoded skyrcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded skyrcoin transaction
