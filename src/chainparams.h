...
#define PORT_MAINNET 16888
#define PORT_TESTNET 26888
#define PORT_REGTEST 27888
 ...
 * Skyrcoin system. There are three: the main network on which people trade goods
