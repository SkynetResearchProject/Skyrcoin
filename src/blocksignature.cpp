...
bool CheckBlockSignature(const CBlock& block, const bool enableP2PKH)
{
    ...
    /** Each block is signed by the private key of the input that is staked. This can be either zSKYR or normal UTXO
     *  zSKYR: Each zSKYR has a keypair associated with it. The serial number is a hash of the public key.
