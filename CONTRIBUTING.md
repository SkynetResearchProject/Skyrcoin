Contributing to Skyrcoin Core
============================

The Skyrcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Skyrcoin Core project, and is not to be
confused with overall Skyrcoin Network Protocol consensus changes.

Whether a pull request is merged into Skyrcoin Core rests with the project merge
...
Patches that change Skyrcoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the Skyrcoin consensus, it must have been
...
The project leader is the release manager for each Skyrcoin Core release.
