...
DefaultDirName={autopf}\Skyrcoin
...
OutputDir=.\output
OutputBaseFilename=SkyrcoinSetup
...
DefaultGroupName=skyrcoin Core
...
[Files]
Source: ".\package\skyrcoin-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Skyrcoin\skyrcoin-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Skyrcoin\Skyrcoin-Qt,strDataDir|{userappdata}\Skyrcoin\}');
  Result := True;
end;
